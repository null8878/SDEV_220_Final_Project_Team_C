...
def get_balances():
    ...
    roommates = [
        request.args.get('rm1', 'Roommate 1').strip(),
        request.args.get('rm2', 'Roommate 2').strip(),
        request.args.get('rm3', 'Roommate 3').strip(),
        request.args.get('rm4', 'Roommate 4').strip(),
    ]

    debts = compute_balances(roommates, expenses)
